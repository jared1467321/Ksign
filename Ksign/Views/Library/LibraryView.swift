...
struct LibraryView: View {
	...
	@State private var _isBulkInstallAfterSignPresenting = false
	@State private var _bulkInstallAfterSignApps: [AppInfoPresentable] = []
    ...
    var body: some View {
		NBNavigationView(.localized("Library")) {
            ...
            .sheet(isPresented: $_isBulkInstallAfterSignPresenting) {
                BulkInstallPreviewView(apps: _bulkInstallAfterSignApps)
                    .presentationDetents([.medium, .large])
                    .presentationDragIndicator(.visible)
            }
			...
			.onReceive(NotificationCenter.default.publisher(for: NSNotification.Name("ksign.bulkSignAndInstall"))) { notification in
				...
				_bulkInstallAfterSignApps = newest
				_isBulkInstallAfterSignPresenting = true
			}
        }
