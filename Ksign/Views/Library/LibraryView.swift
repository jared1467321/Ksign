                ...
                ToolbarItemGroup(placement: .topBarLeading) {
                    ...
                    if _isEditMode.isEditing {
                        Button {
                            ...
                            // Fixed-width icon rather than "Select All"/"Deselect
                            // All" text. The text label grew wider when everything
                            // was selected, which pushed the trailing action
                            // buttons past the nav bar's width and collapsed them
                            // into iOS's (unresponsive) overflow menu. An icon
                            // keeps the leading side a constant, narrow width.
                            Image(systemName: _allCurrentTabSelected ? "checkmark.circle.fill" : "circle")
                        }
                ...
                if _isEditMode.isEditing {
					ToolbarItemGroup(placement: .topBarTrailing) {
                        ...
                        Button {
                            ...
                            NBButton(.localized("Export"), systemImage: "square.and.arrow.up", style: .icon)
                        }
                        .disabled(_selectedApps.isEmpty || _exportManager.isExporting)
