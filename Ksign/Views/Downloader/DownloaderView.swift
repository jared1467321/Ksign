                ...
                ToolbarItemGroup(placement: .topBarLeading) {
                    ...
                    if _isEditMode.isEditing {
                        Button {
                            ...
                            // Icon toggle (matches LibraryView) — a fixed, narrow
                            // width so the trailing action buttons can never be
                            // pushed into iOS's overflow menu.
                            Image(systemName: _allDownloadsSelected ? "checkmark.circle.fill" : "circle")
                        }
